...
<x-guest-layout>
    ...
    <div class="overflow-hidden bg-white pt-24">
        ...
        <div class="text-base leading-7 text-gray-700">
            <p data-aos="zoom-in-up" data-aos-duration="1000" class="text-xl mx-auto max-w-3xl text-center tracking-widest font-lacquer font-semibold leading-7 text-yellow-500">
                Les Oeuvres
            </p>
            <h3 data-aos="zoom-in-down" data-aos-duration="1000" class="mb-8 mx-auto max-w-3xl text-center text-3xl font-barriecito font-bold tracking-tight text-gray-900 sm:text-4xl">
                de {{ $artist->name }}
            </h3>
