        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-20 sm:grid-cols-2 lg:max-w-4xl lg:gap-x-8 xl:max-w-none">
                ...
                <li class="flex flex-col gap-6 xl:flex-row">
                    ...
                    <div class="flex-auto">
                        <h3 class="text-lg font-semibold leading-8 tracking-tight text-gray-900 font-lacquer">{{ $artist->name }}</h3>
                        ...
                        <a href="{{ route('front.artists.show', $artist) }}" class="border rounded-full py-1 px-3 hover:border-yellow-300 transition-all duration-300">
