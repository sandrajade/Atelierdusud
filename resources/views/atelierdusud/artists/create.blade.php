...
<x-app-layout>
    ...
    <div class="bg-white max-w-5xl mx-auto my-12 p-8 shadow-xl">
        ...
        <form action="{{ route('artists.store') }}" method="POST" class="flex flex-col gap-8">
            ...
            <div class="">
                ...
                <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Artiste</label>
                <div class="mt-2">
                    <input type="text" name="name" id="name" placeholder="Entrez le nom de l'artiste" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                    @error('name')
            ...
            <div class="">
                ...
                <div class="mt-2">
                    <textarea type="text" name="description" id="description" cols="50" rows="10" placeholder="Écrivez quelques lignes à propos de l'atiste" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"></textarea>
                </div>
                @error('description')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="">
                {{-- C'est un champ de formulaire de type file pour l'URL ou le statut de l'artiste. Lorsque le formulaire est soumis, les données saisies par l'utilisateur seront utilisées pour créer ou mettre à jour l'URL ou le statut de l'artiste. --}}
