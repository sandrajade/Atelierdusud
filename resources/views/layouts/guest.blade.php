...
<body class="overflow-x-hidden">
    ...
    <header x-data="{ open: false }" class="absolute inset-x-0 top-0 z-50">
        <nav class="fixed inset-x-0 top-0 flex items-center justify-between px-6 py-2 lg:px-8 backdrop-blur-sm bg-white/30" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    <span class="sr-only">{{ config('app.name') }}</span>
                    <img class="h-14 w-auto" src="https://cdn.discordapp.com/attachments/1087640959958929408/1156907729500241980/8347-removebg-preview.png?ex=6516adc9&is=65155c49&hm=451e7c3efeef2ff8d5a95acc8c6ac166746c4b5e4d73ead4d03a6cfc0a251b61&" alt="">
                </a>
            </div>
            <div class="flex lg:hidden">
                <button @click="open = !open" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-white">
        ...
        <div x-cloak x-show="open" class="lg:hidden" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 pt-2 pb-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/25">
                        ...
                        <div class="py-6">
                            <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-800">Se connecter</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="bg-white">
        <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <div class="mt-8 md:order-1 md:mt-0">
                <p class="text-center text-xs leading-5 text-gray-500">&copy; 2023 L'atelier du Sud. Tout droits réservés.</p>
            </div>
        </div>
    </footer>
