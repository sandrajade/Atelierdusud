...
<body class="overflow-x-hidden">
    ...
    <header x-data="{ open: false }" class="absolute inset-x-0 top-0 z-50">
        <nav class="fixed inset-x-0 top-0 flex items-center justify-between px-6 py-2 lg:px-8 backdrop-blur-sm bg-white/30"
            aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="{{ route('welcome') }}"
                    class="text-md font-amaranth tracking-widest leading-6 text-gray-900 border-b-2 hover:border-yellow-300 transition-all duration-300 {{ request()->routeIs('welcome') ? 'border-yellow-300' : 'border-transparent' }}">Accueil</a>
                <a href="{{ route('artists') }}"
                    class="text-md font-amaranth tracking-widest leading-6 text-gray-900 border-b-2 hover:border-yellow-300 transition-all duration-300 {{ request()->routeIs('artists') ? 'border-yellow-300' : 'border-transparent' }}">Artistes</a>
                <a href="{{ route('works') }}"
                    class="text-md font-amaranth tracking-widest leading-6 text-gray-900 border-b-2
                hover:border-yellow-300 transition-all duration-300 {{ request()->routeIs('works') ? 'border-yellow-300' : 'border-transparent' }}">Oeuvres</a>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="{{ route('login') }}" class="text-sm font-semibold leading-6 text-white">Se connecter <span
        ...
        <div x-cloak x-show="open" class="lg:hidden" role="dialog" aria-modal="true">
            ...
            <div
                class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 pt-2 pb-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/25">
                        ...
                        <div class="py-6">
                            <a href="#"
                                class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-800">Se
                                connecter</a>
                        </div>
                    </div>
                </div>
